  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFFE8F2FF), // Light background for AppBar
        iconTheme: const IconThemeData(color: Colors.black87),
        elevation: 1,
      ),
      body: StreamBuilder<QuerySnapshot>(
        // Issues collection එකේ ඇති සියලු documents ලබා ගනී
        stream: FirebaseFirestore.instance
            .collection('issues')
            .orderBy('timestamp', descending: true) // නවතම Issues මුලින්ම පෙන්වයි
            .snapshots(),
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // Status එක අනුව Icon එකේ වර්ණය සහ වර්ගය තීරණය කරයි
              Color statusColor;
              IconData statusIcon;
              ...
              if (status == 'Resolved' || status == 'Completed') {
                ...
                // Pending/New issues රතු පැහැයෙන්
                statusColor = Colors.red.shade700;
                statusIcon = Icons.error;
              } else if (status == 'Ongoing' || status == 'In Progress') {
                // Ongoing issues තැඹිලි පැහැයෙන්
                statusColor = Colors.orange.shade600;
                statusIcon = Icons.pending_actions;
              } else {
                // වෙනත් status සඳහා අළු පැහැයෙන්
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    // TODO: Issue එකේ විස්තර බැලීම සඳහා අදාල පිටුවට navigate කරන්න
