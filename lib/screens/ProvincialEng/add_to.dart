...
class _TORegistrationPageState extends State<TORegistrationPage> {
  ...
  final _userTypeController = TextEditingController(text: 'Technical Officer');
  ...
  // State variables for password validation UI
  ...
  // --- Function to check NIC when focus is lost ---
              ...
              child: Container(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.handyman_outlined, size: 56, color: Colors.blueAccent),
                      const SizedBox(height: 16),
                      const Text(
                        'Technical Officer Signup',
