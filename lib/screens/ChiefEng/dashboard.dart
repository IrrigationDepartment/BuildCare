...
import 'package:buildcare/screens/ChiefEng/sample/issue_detils_page.dart';
import 'package:buildcare/screens/ChiefEng/sample/view_list_screen_page.dart';
        ...
        child: Column(
          children: [
           ...
           // const SizedBox(height: 20),
            ...
            //         context,
            //         MaterialPageRoute(
            //             builder: (context) => SchoolsListScreen()));
            //   },
            // ),
              ...
              children: [
                ...
                _buildDetailCard(
                  ...
                  [
                    ...
                    _buildSchoolTypeRow('School Type', schoolData['schoolType']),
...
/*
============================================
භාවිතා කරන විදිය (How to Use):
============================================

1. pubspec.yaml එකට dependencies add කරන්න:
   dependencies:
     flutter:
       sdk: flutter
...
2. Firebase setup කරන්න ඔයාගේ project එකේ

3. Dashboard එකට card එක add කරන්න:
   SchoolsDashboardCard()

4. Direct schools list එකට යන්න:
   Navigator.push(
     context,
     MaterialPageRoute(
       builder: (context) => SchoolsListPage(),
     ),
   );
...
✅ Professional UI with cards and gradients
✅ Error handling and loading states
✅ Empty state handling
✅ All document fields automatically displayed
✅ Responsive design
✅ Statistics with colored indicators
✅ Dynamic field icons based on field names

============================================
Firebase Structure (schools collection):
============================================
{
