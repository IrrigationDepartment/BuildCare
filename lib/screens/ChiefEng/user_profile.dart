...
class _UserProfilePageState extends State<UserProfilePage> {
  // A Future to fetch the user's data (Removed 'final' so it can be refreshed)
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    try {
      ...
      // 2. Prepare the HTTP request to your server
      // NOTE: You will need a PHP script at this URL to handle the upload!
      var uri = Uri.parse('http://98.94.30.13/profile/upload.php'); 
      var request = http.MultipartRequest('POST', uri);
      
      // Tell the server which folder to put it in (e.g., ChiefE)
      request.fields['folder'] = 'ChiefE'; 
      ...
      if (response.statusCode == 200) {
        ...
        // This assumes your PHP script returns JSON like: {"url": "http://98.94.30.13/profile/ChiefE/example.jpg"}
        String newImageUrl = jsonResponse['url'];
        ...
        // 5. Refresh the UI by re-fetching the user future
        setState(() {
        ...
        builder: (context, snapshot) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // --- MODIFIED: Profile Image with Upload logic ---
                Center(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          backgroundImage: (profileImageUrl.isNotEmpty)
                              ...
                              : null,
                          child: (profileImageUrl.isEmpty && !_isUploading)
                              ? const Icon(
                                  Icons.person,
                                  size: 60,
                                  color: Colors.white,
