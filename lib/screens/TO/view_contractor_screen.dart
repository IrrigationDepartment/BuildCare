    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final String idType = (data['idType'] ?? 'NIC').toString();
          final String idLabel = idType == 'BRN' ? 'BRN Number' : 'NIC Number';
          final String idValue = (data['idNumber'] ?? data['nic'] ?? 'N/A')
              .toString()
              .trim()
              .isEmpty
              ? 'N/A'
              : (data['idNumber'] ?? data['nic'] ?? 'N/A').toString();
