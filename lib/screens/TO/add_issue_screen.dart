...
class _AddIssueScreenState extends State<AddIssueScreen> {
  ...
  if (!_schoolFocusNode.hasFocus) {
    // Delay gives onTapDown time to fire before overlay is removed
  ...
  void _onSchoolSelected(Map<String, dynamic> school) {
    ...
    setState(() {
      ...
      // Reset building selection since school changed
            ...
            child: Column(
              ...
              children: _schoolSuggestions.map((school) {
                return GestureDetector(
                  // KEY FIX: onTapDown fires BEFORE focus is lost
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        const Icon(Icons.school_outlined, size: 18, color: _primaryIndigo),
  ...
  double _getSchoolFieldWidth() {

    // Fallback width; overlay uses CompositedTransformFollower so this is approximate
  ...
  Future<void> _loadIssueData() async {
    ...
    try {
      ...
      if (doc.exists) {
        ...
        // Load school buildings for edit mode
        ...
        if (data['schoolName'] != null) {
          ...
          if (schoolSnap.docs.isNotEmpty) {
            ...
            _schoolBuildingNames = List<String>.from(schoolData['buildingNames'] ?? []);
  ...
  Widget _buildResponsiveGrid(bool isWide) {
    ...
    return Column(
      ...
      children: [
        ...
        // Building dropdown: from school's buildingNames if school selected, else show locked state
  ...
  /// School name field with autocomplete overlay
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('School Name', style: TextStyle(fontWeight: FontWeight.w600, color: _textDark)),
          ...
          CompositedTransformTarget(
            ...
            child: TextFormField(
              ...
              decoration: _inputDecoration('Enter school name').copyWith(
                ...
                suffixIcon: _isLoadingSchools
                    ...
                    ? const Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: CircularProgressIndicator(strokeWidth: 2, color: _primaryIndigo),
          ...
          if (!_schoolSelected && _schoolNameController.text.length >= 2 && _schoolSuggestions.isEmpty && !_isLoadingSchools)
  ...
  /// Damage Building dropdown — uses school's buildingNames when a school is selected

  Widget _buildBuildingDropdown(bool isWide) {

    final bool hasBuildings = _schoolBuildingNames.isNotEmpty;

    final buildingItems = hasBuildings ? _schoolBuildingNames : <String>[];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Damage Building', style: TextStyle(fontWeight: FontWeight.w600, color: _textDark)),
                ...
                IgnorePointer(
                  ...
                  child: Opacity(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: _schoolSelected ? (val) => setState(() => _selectedBuilding = val) : null,

                      decoration: _inputDecoration(

                        _schoolSelected ? 'Select building' : 'Select a school first',
                ...
                if (_schoolSelected && !hasBuildings)
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      'No buildings registered for this school.',
        ...
        if (isWide)
          ...
          Expanded(
            ...
            child: _buildDropdown(
              ...
              "Damage Type", "Select type", _damageTypes,

              _selectedDamageType, (val) => setState(() => _selectedDamageType = val),
