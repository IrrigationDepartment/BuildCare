...
// --- 1. 'add_contract.dart' IMPORT කිරීම ---
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // --- 2. EDIT BUTTON ACTION එක වෙනස් කිරීම ---
              SizedBox(
                width: double.infinity,
                child: ElevatedButton.icon(
                  onPressed: () {
                    // 'Edit' screen එකට navigate කිරීම
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => AddContractScreen(
                          contractId: contractId, // Document ID එක pass කිරීම
                          initialData: data,      // පවතින data ටික pass කිරීම
                        ),
                      ),
                    );
                  },
