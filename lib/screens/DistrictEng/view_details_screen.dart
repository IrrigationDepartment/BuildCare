// File: view_details_screen.dart (Contents were in contract_details.dart)
...
class ViewContractDetailsScreen extends StatelessWidget {
  ...
  Widget _buildDetailsCard(BuildContext context, Map<String, dynamic> data) {
    ...
    String formatCurrency(dynamic value) {
      if (value is num) {
        // LKR is Sri Lankan Rupee. Using en_US locale for number formatting style.
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Note: The 'Edit Details' button and its associated SizedBox/ElevatedButton are removed as requested.
            ],
          ),
        ),
      ),
